...
while True:
    user = api.get_user('AnaghaKrishnak1')
    api.update_profile(name=f'ANAGHA|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : ANAGHA|{follower_count(user)} Followers')
